# This is a generated file! Please edit the [source .ksy file](https://github.com/kaitai-io/kaitai_struct_formats/blob/master/scientific/nt_mdt/nt_mdt_pal.ksy) and use [kaitai-struct-compiler](https://github.com/kaitai-io/kaitai_struct) to rebuild
